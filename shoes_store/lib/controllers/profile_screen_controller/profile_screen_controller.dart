...
class ProfileScreenController extends GetxController {
  ...
  RxList<Datum> countryLists = [
    Datum(id: 0, name: 'Select Country', sortname: ''),
  ].obs;
  RxList<DatumState> stateLists = [
    DatumState(id: 0, name: 'Select State', countryId: 0),
  ].obs;
  RxList<DatumCity> cityLists = [
    DatumCity(id: 0, name: 'Select City', stateId: 0),
  ].obs;
    ...
    try {
      if (file != null) {
        ...
        response.stream.transform(utf8.decoder).listen((value) {
          UpdateProfileData response1 =
              UpdateProfileData.fromJson(json.decode(value));
